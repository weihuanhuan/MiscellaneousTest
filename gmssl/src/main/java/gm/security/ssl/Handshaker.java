...
import static gm.security.ssl.CipherSuite.PRF.*;
import static gm.security.ssl.CipherSuite.CipherType.*;
...
abstract class Handshaker {
    ...
    static final boolean allowUnsafeRenegotiation = Debug.getBooleanProperty(
                    "gm.security.ssl.allowUnsafeRenegotiation", false);
    ...
    static final boolean allowLegacyHelloMessages = Debug.getBooleanProperty(
                    "gm.security.ssl.allowLegacyHelloMessages", true);
