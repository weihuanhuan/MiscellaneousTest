...
import gm.security.provider.internal.*;
...
public abstract class SunJSSE extends java.security.Provider {
    ...
    private void doRegister(boolean isfips) {
        ...
        put("Signature.MD5andSHA1withRSA",
            "gm.security.ssl.RSASignature");

        put("KeyManagerFactory.SunX509",
            "gm.security.ssl.KeyManagerFactoryImpl$SunX509");
        put("KeyManagerFactory.NewSunX509",
            "gm.security.ssl.KeyManagerFactoryImpl$X509");
        put("Alg.Alias.KeyManagerFactory.PKIX", "NewSunX509");

        put("TrustManagerFactory.SunX509",
            "gm.security.ssl.TrustManagerFactoryImpl$SimpleFactory");
        put("TrustManagerFactory.PKIX",
            "gm.security.ssl.TrustManagerFactoryImpl$PKIXFactory");
        put("Alg.Alias.TrustManagerFactory.SunPKIX", "PKIX");
        put("Alg.Alias.TrustManagerFactory.X509", "PKIX");
        put("Alg.Alias.TrustManagerFactory.X.509", "PKIX");

        put("SSLContext.TLSv1",
            "gm.security.ssl.SSLContextImpl$TLS10Context");
        put("SSLContext.TLSv1.1",
            "gm.security.ssl.SSLContextImpl$TLS11Context");
        put("SSLContext.TLSv1.2",
            "gm.security.ssl.SSLContextImpl$TLS12Context");
        put("SSLContext.TLS",
            "gm.security.ssl.SSLContextImpl$TLSContext");
        if (isfips == false) {
        ...
        put("SSLContext.Default",
            "gm.security.ssl.SSLContextImpl$DefaultSSLContext");
        ...
        put("KeyGenerator.GMSSLPrfGenerator","com.gm.crypto.provider.TlsPrfGenerator$GMSSLPrfGenerator");

        //JF HmacSM3
        put("MAC.HmacSM3","com.gm.crypto.provider.HmacCore$HmacSM3");
