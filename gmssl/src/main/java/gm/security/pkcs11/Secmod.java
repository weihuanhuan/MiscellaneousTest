 ...
 *   }
 *
 *   GMProvider p = secmod.getModule(ModuleType.KEYSTORE).getProvider();
...
public final class Secmod {
    ...
    static {
        gm.security.pkcs11.wrapper.PKCS11.loadNative();
        INSTANCE = new Secmod();
    }
    ...
    public static final class Module {
        ...
        public synchronized void setConfiguration(String config) {
            if (provider != null) {
                throw new IllegalStateException("GMProvider instance already created");
            }
            this.config = config;
        }
