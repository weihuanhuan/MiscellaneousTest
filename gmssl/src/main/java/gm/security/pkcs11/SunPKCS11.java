...
import gm.security.util.Debug;
import gm.security.util.ResourcesMgr;

import gm.security.pkcs11.Secmod.*;

import gm.security.pkcs11.wrapper.*;
import static gm.security.pkcs11.wrapper.PKCS11Constants.*;
...
public final class SunPKCS11 extends AuthProvider {
    ...
    static {
        ...
        String P11Digest           = "gm.security.pkcs11.P11Digest";
        String P11MAC              = "gm.security.pkcs11.P11MAC";
        String P11KeyPairGenerator = "gm.security.pkcs11.P11KeyPairGenerator";
        String P11KeyGenerator     = "gm.security.pkcs11.P11KeyGenerator";
        String P11RSAKeyFactory    = "gm.security.pkcs11.P11RSAKeyFactory";
        String P11DSAKeyFactory    = "gm.security.pkcs11.P11DSAKeyFactory";
        String P11DHKeyFactory     = "gm.security.pkcs11.P11DHKeyFactory";
        String P11KeyAgreement     = "gm.security.pkcs11.P11KeyAgreement";
        String P11SecretKeyFactory = "gm.security.pkcs11.P11SecretKeyFactory";
        String P11Cipher           = "gm.security.pkcs11.P11Cipher";
        String P11RSACipher        = "gm.security.pkcs11.P11RSACipher";
        String P11Signature        = "gm.security.pkcs11.P11Signature";
        ...
        d(AGP, "EC",            "gm.security.ec.ECParameters",
                                                s("1.2.840.10045.2.1"),
                m(CKM_EC_KEY_PAIR_GEN, CKM_ECDH1_DERIVE,
                    CKM_ECDSA, CKM_ECDSA_SHA1));
        ...
        d(KA, "ECDH",           "gm.security.pkcs11.P11ECDHKeyAgreement",
                m(CKM_ECDH1_DERIVE));
         ...
         * GMProvider.Service.supportsParameters()), and we would also
        ...
        d(KG, "SunTlsRsaPremasterSecret",
                    "gm.security.pkcs11.P11TlsRsaPremasterSecretGenerator",
                m(CKM_SSL3_PRE_MASTER_KEY_GEN, CKM_TLS_PRE_MASTER_KEY_GEN));
        d(KG, "SunTlsMasterSecret",
                    "gm.security.pkcs11.P11TlsMasterSecretGenerator",
                m(CKM_SSL3_MASTER_KEY_DERIVE, CKM_TLS_MASTER_KEY_DERIVE,
                    CKM_SSL3_MASTER_KEY_DERIVE_DH,
                    CKM_TLS_MASTER_KEY_DERIVE_DH));
        d(KG, "SunTlsKeyMaterial",
                    "gm.security.pkcs11.P11TlsKeyMaterialGenerator",
                m(CKM_SSL3_KEY_AND_MAC_DERIVE, CKM_TLS_KEY_AND_MAC_DERIVE));
        d(KG, "SunTlsPrf", "gm.security.pkcs11.P11TlsPrfGenerator",
    ...
    private static final class P11Service extends Service {
        ...
        public Object newInstance0(Object param) throws
            ...
            if (type == MD) {
                ...
                return new gm.security.ec.ECParameters();
            } else {
