...
import gm.security.rsa.RSAPublicKeyImpl;
...
import gm.security.util.Length;
    ...
    private static final class P11DSAPublicKey extends P11Key
        ...
        synchronized byte[] getEncodedInternal() {
            ...
            if (encoded == null) {
                fetchValues();
                try {
                    Key key = new gm.security.provider.DSAPublicKey
    ...
    private static final class P11DSAPrivateKey extends P11Key
        ...
        synchronized byte[] getEncodedInternal() {
            ...
            if (encoded == null) {
                fetchValues();
                try {
                    Key key = new gm.security.provider.DSAPrivateKey
