...
final class SunECEntries {
    ...
    static void putEntries(Map<Object, Object> map,
         ...
         *  Key Factory engine
         */
        map.put("KeyFactory.EC", "gm.security.ec.ECKeyFactory");
         ...
         */
        map.put("AlgorithmParameters.EC", "gm.security.ec.ECParameters");
        ...
        map.put("Signature.NONEwithECDSA",
            "gm.security.ec.ECDSASignature$Raw");
        map.put("Signature.SHA1withECDSA",
            "gm.security.ec.ECDSASignature$SHA1");
        ...
        map.put("Signature.SHA224withECDSA",
            "gm.security.ec.ECDSASignature$SHA224");
        ...
        map.put("Signature.SHA256withECDSA",
            "gm.security.ec.ECDSASignature$SHA256");
        ...
        map.put("Signature.SHA384withECDSA",
            "gm.security.ec.ECDSASignature$SHA384");
        ...
        map.put("Signature.SHA512withECDSA",
            "gm.security.ec.ECDSASignature$SHA512");
         ...
         */
        map.put("KeyPairGenerator.EC", "gm.security.ec.ECKeyPairGenerator");
         ...
         */
        map.put("KeyAgreement.ECDH", "gm.security.ec.ECDHKeyAgreement");
