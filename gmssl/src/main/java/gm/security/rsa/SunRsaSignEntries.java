...
public final class SunRsaSignEntries {
    ...
    public static void putEntries(Map<Object, Object> map) {
        ...
        map.put("Signature.SHA224withRSA",
                "gm.security.rsa.RSASignature$SHA224withRSA");
        map.put("Signature.SHA256withRSA",
                "gm.security.rsa.RSASignature$SHA256withRSA");
        map.put("Signature.SHA384withRSA",
                "gm.security.rsa.RSASignature$SHA384withRSA");
        map.put("Signature.SHA512withRSA",
                "gm.security.rsa.RSASignature$SHA512withRSA");
