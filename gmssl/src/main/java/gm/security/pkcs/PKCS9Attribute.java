...
import gm.security.x509.CertificateExtensions;
    ...
    static {
        try {
            ...
            VALUE_CLASSES[3] =        // ContentType
                Class.forName("gm.security.util.ObjectIdentifier");
            ...
            VALUE_CLASSES[6] =        // Countersignature
                Class.forName("[Lgm.security.pkcs.SignerInfo;");
            ...
            VALUE_CLASSES[14] =        // ExtensionRequest
                Class.forName("gm.security.x509.CertificateExtensions");
