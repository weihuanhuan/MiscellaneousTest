...
import static gm.security.provider.certpath.OCSP.*;
import static gm.security.provider.certpath.PKIX.*;
import gm.security.x509.*;
            ...
            new PrivilegedAction<RevocationProperties>() {
                public RevocationProperties run() {
                    ...
                    String onlyEE = Security.getProperty(
                        "com.gm.security.onlyCheckRevocationOfEECert");
                    ...
                    rp.crlDPEnabled
                        = Boolean.getBoolean("com.gm.security.enableCRLDP");
                    return rp;
                }
            }
        );
