...
package gm.security.provider.internal;

import gm.security.ssl.SunJSSE;
 ...
 * continue to use this class as the main GMProvider class.
 */
public final class GMProvider extends SunJSSE {
    ...
    public GMProvider(java.security.Provider cryptoProvider) {
        super(cryptoProvider);
    }

    // constructor to enable FIPS mode from java.security file
    public GMProvider(String cryptoProvider) {
        super(cryptoProvider);
    }
