...
package gm.security.provider;

import java.io.*;
import java.net.*;
import java.util.Map;
import java.security.*;
import gm.security.action.GetPropertyAction;
import gm.security.provider.NativePRNG;
    ...
    static void putEntries(Map<Object, Object> map) {
        ...
        if (nativeAvailable && useNativePRNG) {
            map.put("SecureRandom.NativePRNG",
                "gm.security.provider.NativePRNG");
        }
        map.put("SecureRandom.SHA1PRNG",
             "gm.security.provider.SecureRandom");
        if (nativeAvailable && !useNativePRNG) {
            map.put("SecureRandom.NativePRNG",
                "gm.security.provider.NativePRNG");
        }
        ...
        if (NativePRNG.Blocking.isAvailable()) {
            map.put("SecureRandom.NativePRNGBlocking",
                "gm.security.provider.NativePRNG$Blocking");
        }

        if (NativePRNG.NonBlocking.isAvailable()) {
            map.put("SecureRandom.NativePRNGNonBlocking",
                "gm.security.provider.NativePRNG$NonBlocking");
        }
        ...
        map.put("Signature.SHA1withDSA",
                "gm.security.provider.DSA$SHA1withDSA");
        map.put("Signature.NONEwithDSA", "gm.security.provider.DSA$RawDSA");
        map.put("Alg.Alias.Signature.RawDSA", "NONEwithDSA");
        map.put("Signature.SHA224withDSA",
                "gm.security.provider.DSA$SHA224withDSA");
        map.put("Signature.SHA256withDSA",
                "gm.security.provider.DSA$SHA256withDSA");
         ...
         */
        String dsaKPGImplClass = "gm.security.provider.DSAKeyPairGenerator$";
         ...
         * Digest engines
         */
        map.put("MessageDigest.MD2", "gm.security.provider.MD2");
        map.put("MessageDigest.MD5", "gm.security.provider.MD5");
        map.put("MessageDigest.SHA", "gm.security.provider.SHA");
        ...
        map.put("AlgorithmParameterGenerator.DSA",
            "gm.security.provider.DSAParameterGenerator");

        /*
         * Algorithm Parameter engines
         */
        map.put("AlgorithmParameters.DSA",
            "gm.security.provider.DSAParameters");
         ...
         * Key factories
         */
        map.put("KeyFactory.DSA", "gm.security.provider.DSAKeyFactory");
        ...
        map.put("CertificateFactory.X.509",
            "gm.security.provider.X509Factory");
        ...
        map.put("KeyStore.JKS",
                        "gm.security.provider.JavaKeyStore$DualFormatJKS");
        map.put("KeyStore.CaseExactJKS",
                        "gm.security.provider.JavaKeyStore$CaseExactJKS");
        map.put("KeyStore.DKS", "gm.security.provider.DomainKeyStore$DKS");

        /*
         * Policy
         */
        map.put("Policy.JavaPolicy", "gm.security.provider.PolicySpiFile");

        /*
         * Configuration
         */
        map.put("Configuration.JavaLoginConfig",
                        "gm.security.provider.ConfigFile$Spi");

        /*
         * CertPathBuilder
         */
        map.put("CertPathBuilder.PKIX",
            "gm.security.provider.certpath.SunCertPathBuilder");
        ...
        map.put("CertPathValidator.PKIX",
            "gm.security.provider.certpath.PKIXCertPathValidator");
        ...
        map.put("CertStore.LDAP",
            "gm.security.provider.certpath.ldap.LDAPCertStore");
        map.put("CertStore.LDAP LDAPSchema", "RFC2587");
        map.put("CertStore.Collection",
            "gm.security.provider.certpath.CollectionCertStore");
        map.put("CertStore.com.gm.security.IndexedCollection",
            "gm.security.provider.certpath.IndexedCollectionCertStore");
        ...
        map.put("CertStore.com.gm.security.IndexedCollection ImplementedIn",
            "Software");
