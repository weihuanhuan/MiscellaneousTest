...
public class DSAKeyFactory extends KeyFactorySpi {
    ...
    private static final String SERIAL_PROP = "gm.security.key.serial.interop";
    ...
    static {
         ...
         * JDK 1.4.
         *
         * If true, then we generate gm.security.provider.DSAPublicKey.
         * If false, then we generate gm.security.provider.DSAPublicKeyImpl.
         *
    ...
    protected Key engineTranslateKey(Key key) throws InvalidKeyException {
        ...
        try {
            ...
            if (key instanceof java.security.interfaces.DSAPublicKey) {
                ...
                if (key instanceof gm.security.provider.DSAPublicKey) {
                    return key;
                }
                // Convert key to spec
                ...
                // Check if key originates from this factory
                if (key instanceof gm.security.provider.DSAPrivateKey) {
                    return key;
                }
                // Convert key to spec
