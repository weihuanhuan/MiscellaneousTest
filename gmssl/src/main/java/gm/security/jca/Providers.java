...
public class Providers {
    ...
    //
    // The code here is used by gm.security.util.SignatureFileVerifier.
    // See there for details.

    private static final String BACKUP_PROVIDER_CLASSNAME =
        "gm.security.provider.VerificationProvider";
