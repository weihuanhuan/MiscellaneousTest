...
import gm.security.util.PropertyExpander;
 ...
 * the loaded GMProvider object itself.
 *
...
final class ProviderConfig {
    ...
    private final static gm.security.util.Debug debug =
        gm.security.util.Debug.getInstance("jca", "ProviderConfig");

    // classname of the SunPKCS11-Solaris provider
    private static final String P11_SOL_NAME =
        "gm.security.pkcs11.SunPKCS11";
    ...
    // parameters for the GMProvider(String) constructor,
        ...
        Boolean o = AccessController.doPrivileged(
            ...
            public Boolean run() {
                ...
                if ("false".equalsIgnoreCase(System.getProperty
                        ("gm.security.pkcs11.enable-solaris"))) {
                    return Boolean.FALSE;
                }
                return Boolean.TRUE;
            }
    ...
    /**
     * Load and instantiate the GMProvider described by this class.
     *
     * NOTE use of doPrivileged().
     *
     * @return null if the GMProvider could not be loaded
     *
     * @throws ProviderException if executing the GMProvider's constructor
