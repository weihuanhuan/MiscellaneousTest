...
public class BCECUtil {
    ...
    public static AsymmetricCipherKeyPair generateKeyPair(ECDomainParameters domainParameters,
        SecureRandom random) {
        final ECKeyGenerationParameters ecKeyGenerationParameters = new ECKeyGenerationParameters(domainParameters,
                random);
        ECKeyGenerationParameters keyGenerationParams = ecKeyGenerationParameters;
