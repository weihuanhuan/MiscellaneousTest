package concurrency.ThreadPoolExecutorTest.task;

import concurrency.ThreadPoolExecutorTest.VersionWrapper;
import concurrency.ThreadPoolExecutorTest.tracker.VersionTracker;
import concurrency.ThreadPoolExecutorTest.MainExecutorTest;
    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                T simpleSession = simpleSessions[random.nextInt(MainExecutorTest.MAX_SESSION_QUANTITY)];
