...
import annotation.anno.AnnoA;
import annotation.clazz.A;
import annotation.clazz.B;
import annotation.clazz.C;
import annotation.clazz.D;
...
public class Main {
    ...
    public static void printAnnotationInfo(Class<?> clazz) {
        //不包括继承来的注解
        Annotation[] annoOfD = clazz.getDeclaredAnnotations();
        String strOfD = Arrays.deepToString(annoOfD);
        System.out.println("DeclaredAnnotations = " + strOfD);

        //包括继承来的注解
        annoOfD = clazz.getAnnotations();
        strOfD = Arrays.deepToString(annoOfD);
        System.out.println("Annotations=          " + strOfD);
