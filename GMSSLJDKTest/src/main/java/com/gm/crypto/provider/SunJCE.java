        ...
        AccessController.doPrivileged(
            new java.security.PrivilegedAction<Object>() {
                public Object run() {
                     ...
                     * Cipher engines
                     */
                    put("Cipher.RSA", "com.gm.crypto.provider.RSACipher");
                    ...
                    put("Cipher.DES", "com.gm.crypto.provider.DESCipher");
                    ...
                    put("Cipher.DESede", "com.gm.crypto.provider.DESedeCipher");
                    ...
                    put("Cipher.DESedeWrap",
                        "com.gm.crypto.provider.DESedeWrapCipher");
                    ...
                    put("Cipher.PBEWithMD5AndDES",
                        "com.gm.crypto.provider.PBEWithMD5AndDESCipher");
                    ...
                    put("Cipher.PBEWithMD5AndTripleDES",
                        "com.gm.crypto.provider.PBEWithMD5AndTripleDESCipher");

                    put("Cipher.PBEWithSHA1AndDESede",
                        "com.gm.crypto.provider.PKCS12PBECipherCore$" +
                    ...
                    put("Cipher.PBEWithHmacSHA1AndAES_128",
                        "com.gm.crypto.provider.PBES2Core$HmacSHA1AndAES_128");

                    put("Cipher.PBEWithHmacSHA224AndAES_128",
                        "com.gm.crypto.provider.PBES2Core$" +
                    ...
                    put("Cipher.PBEWithHmacSHA1AndAES_256",
                        "com.gm.crypto.provider.PBES2Core$HmacSHA1AndAES_256");
                    ...
                    put("Cipher.Blowfish",
                        "com.gm.crypto.provider.BlowfishCipher");
                    ...
                    put("Cipher.AES", "com.gm.crypto.provider.AESCipher$General");
                    ...
                    put("Cipher.AES_128/ECB/NoPadding", "com.gm.crypto.provider.AESCipher$AES128_ECB_NoPadding");
                    ...
                    put("Cipher.AES_128/CBC/NoPadding", "com.gm.crypto.provider.AESCipher$AES128_CBC_NoPadding");
                    ...
                    put("Cipher.AES_128/OFB/NoPadding", "com.gm.crypto.provider.AESCipher$AES128_OFB_NoPadding");
                    ...
                    put("Cipher.AES_128/CFB/NoPadding", "com.gm.crypto.provider.AESCipher$AES128_CFB_NoPadding");
                    ...
                    put("Cipher.AES_128/GCM/NoPadding", "com.gm.crypto.provider.AESCipher$AES128_GCM_NoPadding");
                    ...
                    put("Cipher.AES_192/ECB/NoPadding", "com.gm.crypto.provider.AESCipher$AES192_ECB_NoPadding");
                    ...
                    put("Cipher.AES_192/CBC/NoPadding", "com.gm.crypto.provider.AESCipher$AES192_CBC_NoPadding");
                    ...
                    put("Cipher.AES_192/OFB/NoPadding", "com.gm.crypto.provider.AESCipher$AES192_OFB_NoPadding");
                    ...
                    put("Cipher.AES_192/CFB/NoPadding", "com.gm.crypto.provider.AESCipher$AES192_CFB_NoPadding");
                    ...
                    put("Cipher.AES_192/GCM/NoPadding", "com.gm.crypto.provider.AESCipher$AES192_GCM_NoPadding");
                    ...
                    put("Cipher.AES_256/ECB/NoPadding", "com.gm.crypto.provider.AESCipher$AES256_ECB_NoPadding");
                    ...
                    put("Cipher.AES_256/CBC/NoPadding", "com.gm.crypto.provider.AESCipher$AES256_CBC_NoPadding");
                    ...
                    put("Cipher.AES_256/OFB/NoPadding", "com.gm.crypto.provider.AESCipher$AES256_OFB_NoPadding");
                    ...
                    put("Cipher.AES_256/CFB/NoPadding", "com.gm.crypto.provider.AESCipher$AES256_CFB_NoPadding");
                    ...
                    put("Cipher.AES_256/GCM/NoPadding", "com.gm.crypto.provider.AESCipher$AES256_GCM_NoPadding");
                    ...
                    put("Cipher.ARCFOUR",
                        "com.gm.crypto.provider.ARCFOURCipher");
                    ...
                    put("KeyGenerator.DES",
                        "com.gm.crypto.provider.DESKeyGenerator");

                    put("KeyGenerator.DESede",
                        "com.gm.crypto.provider.DESedeKeyGenerator");
                    put("Alg.Alias.KeyGenerator.TripleDES", "DESede");

                    put("KeyGenerator.Blowfish",
                        "com.gm.crypto.provider.BlowfishKeyGenerator");

                    put("KeyGenerator.AES",
                        "com.gm.crypto.provider.AESKeyGenerator");
                    put("Alg.Alias.KeyGenerator.Rijndael", "AES");

                    put("KeyGenerator.RC2",
                        "com.gm.crypto.provider.KeyGeneratorCore$" +
                        "RC2KeyGenerator");
                    ...
                    put("KeyGenerator.HmacMD5",
                        "com.gm.crypto.provider.HmacMD5KeyGenerator");

                    put("KeyGenerator.HmacSHA1",
                        "com.gm.crypto.provider.HmacSHA1KeyGenerator");
                    ...
                    put("KeyGenerator.HmacSHA224",
                        "com.gm.crypto.provider.KeyGeneratorCore$HmacSHA2KG$SHA224");
                    ...
                    put("KeyGenerator.HmacSHA256",
                        "com.gm.crypto.provider.KeyGeneratorCore$HmacSHA2KG$SHA256");
                    ...
                    put("KeyGenerator.HmacSHA384",
                        "com.gm.crypto.provider.KeyGeneratorCore$HmacSHA2KG$SHA384");
                    ...
                    put("KeyGenerator.HmacSHA512",
                        "com.gm.crypto.provider.KeyGeneratorCore$HmacSHA2KG$SHA512");
                    ...
                    put("KeyPairGenerator.DiffieHellman",
                        "com.gm.crypto.provider.DHKeyPairGenerator");
                    ...
                    put("AlgorithmParameterGenerator.DiffieHellman",
                        "com.gm.crypto.provider.DHParameterGenerator");
                    ...
                    put("KeyAgreement.DiffieHellman",
                        "com.gm.crypto.provider.DHKeyAgreement");
                    ...
                    put("AlgorithmParameters.DiffieHellman",
                        "com.gm.crypto.provider.DHParameters");
                    ...
                    put("AlgorithmParameters.DES",
                        "com.gm.crypto.provider.DESParameters");

                    put("AlgorithmParameters.DESede",
                        "com.gm.crypto.provider.DESedeParameters");
                    put("Alg.Alias.AlgorithmParameters.TripleDES", "DESede");

                    put("AlgorithmParameters.PBE",
                        "com.gm.crypto.provider.PBEParameters");
                    ...
                    put("AlgorithmParameters.PBES2",
                        "com.gm.crypto.provider.PBES2Parameters$General");
                    ...
                    put("AlgorithmParameters.PBEWithHmacSHA1AndAES_128",
                        "com.gm.crypto.provider.PBES2Parameters$HmacSHA1AndAES_128");

                    put("AlgorithmParameters.PBEWithHmacSHA224AndAES_128",
                        "com.gm.crypto.provider.PBES2Parameters$HmacSHA224AndAES_128");

                    put("AlgorithmParameters.PBEWithHmacSHA256AndAES_128",
                        "com.gm.crypto.provider.PBES2Parameters$HmacSHA256AndAES_128");

                    put("AlgorithmParameters.PBEWithHmacSHA384AndAES_128",
                        "com.gm.crypto.provider.PBES2Parameters$HmacSHA384AndAES_128");

                    put("AlgorithmParameters.PBEWithHmacSHA512AndAES_128",
                        "com.gm.crypto.provider.PBES2Parameters$HmacSHA512AndAES_128");

                    put("AlgorithmParameters.PBEWithHmacSHA1AndAES_256",
                        "com.gm.crypto.provider.PBES2Parameters$HmacSHA1AndAES_256");

                    put("AlgorithmParameters.PBEWithHmacSHA224AndAES_256",
                        "com.gm.crypto.provider.PBES2Parameters$HmacSHA224AndAES_256");

                    put("AlgorithmParameters.PBEWithHmacSHA256AndAES_256",
                        "com.gm.crypto.provider.PBES2Parameters$HmacSHA256AndAES_256");

                    put("AlgorithmParameters.PBEWithHmacSHA384AndAES_256",
                        "com.gm.crypto.provider.PBES2Parameters$HmacSHA384AndAES_256");

                    put("AlgorithmParameters.PBEWithHmacSHA512AndAES_256",
                        "com.gm.crypto.provider.PBES2Parameters$HmacSHA512AndAES_256");

                    put("AlgorithmParameters.Blowfish",
                        "com.gm.crypto.provider.BlowfishParameters");

                    put("AlgorithmParameters.AES",
                        "com.gm.crypto.provider.AESParameters");
                    put("Alg.Alias.AlgorithmParameters.Rijndael", "AES");
                    put("AlgorithmParameters.GCM",
                        "com.gm.crypto.provider.GCMParameters");


                    put("AlgorithmParameters.RC2",
                        "com.gm.crypto.provider.RC2Parameters");

                    put("AlgorithmParameters.OAEP",
                        "com.gm.crypto.provider.OAEPParameters");

                    /*
                     * Key factories
                     */
                    put("KeyFactory.DiffieHellman",
                        "com.gm.crypto.provider.DHKeyFactory");
                    ...
                    put("SecretKeyFactory.DES",
                        "com.gm.crypto.provider.DESKeyFactory");

                    put("SecretKeyFactory.DESede",
                        "com.gm.crypto.provider.DESedeKeyFactory");
                    put("Alg.Alias.SecretKeyFactory.TripleDES", "DESede");

                    put("SecretKeyFactory.PBEWithMD5AndDES",
                        "com.gm.crypto.provider.PBEKeyFactory$PBEWithMD5AndDES"
                        );
                    ...
                    put("SecretKeyFactory.PBEWithMD5AndTripleDES",
                        "com.gm.crypto.provider.PBEKeyFactory$" +
                        "PBEWithMD5AndTripleDES"
                        );

                    put("SecretKeyFactory.PBEWithSHA1AndDESede",
                        "com.gm.crypto.provider.PBEKeyFactory$PBEWithSHA1AndDESede"
                        );
                    ...
                    put("SecretKeyFactory.PBEWithSHA1AndRC2_40",
                        "com.gm.crypto.provider.PBEKeyFactory$PBEWithSHA1AndRC2_40"
                        );
                    ...
                    put("SecretKeyFactory.PBEWithSHA1AndRC2_128",
                        "com.gm.crypto.provider.PBEKeyFactory$PBEWithSHA1AndRC2_128"
                        );
                    ...
                    put("SecretKeyFactory.PBEWithSHA1AndRC4_40",
                        "com.gm.crypto.provider.PBEKeyFactory$PBEWithSHA1AndRC4_40"
                        );
                    ...
                    put("SecretKeyFactory.PBEWithSHA1AndRC4_128",
                        "com.gm.crypto.provider.PBEKeyFactory$PBEWithSHA1AndRC4_128"
                        );
                    ...
                    put("SecretKeyFactory.PBKDF2WithHmacSHA1",
                        "com.gm.crypto.provider.PBKDF2Core$HmacSHA1");
                    ...
                    put("SecretKeyFactory.PBKDF2WithHmacSHA224",
                        "com.gm.crypto.provider.PBKDF2Core$HmacSHA224");
                    put("SecretKeyFactory.PBKDF2WithHmacSHA256",
                        "com.gm.crypto.provider.PBKDF2Core$HmacSHA256");
                    put("SecretKeyFactory.PBKDF2WithHmacSHA384",
                        "com.gm.crypto.provider.PBKDF2Core$HmacSHA384");
                    put("SecretKeyFactory.PBKDF2WithHmacSHA512",
                        "com.gm.crypto.provider.PBKDF2Core$HmacSHA512");

                    /*
                     * MAC
                     */
                    put("Mac.HmacMD5", "com.gm.crypto.provider.HmacMD5");
                    put("Mac.HmacSHA1", "com.gm.crypto.provider.HmacSHA1");
                    put("Alg.Alias.Mac.OID.1.2.840.113549.2.7", "HmacSHA1");
                    put("Alg.Alias.Mac.1.2.840.113549.2.7", "HmacSHA1");
                    put("Mac.HmacSHA224",
                        "com.gm.crypto.provider.HmacCore$HmacSHA224");
                    put("Alg.Alias.Mac.OID.1.2.840.113549.2.8", "HmacSHA224");
                    put("Alg.Alias.Mac.1.2.840.113549.2.8", "HmacSHA224");
                    put("Mac.HmacSHA256",
                        "com.gm.crypto.provider.HmacCore$HmacSHA256");
                    put("Alg.Alias.Mac.OID.1.2.840.113549.2.9", "HmacSHA256");
                    put("Alg.Alias.Mac.1.2.840.113549.2.9", "HmacSHA256");
                    put("Mac.HmacSHA384",
                        "com.gm.crypto.provider.HmacCore$HmacSHA384");
                    put("Alg.Alias.Mac.OID.1.2.840.113549.2.10", "HmacSHA384");
                    put("Alg.Alias.Mac.1.2.840.113549.2.10", "HmacSHA384");
                    put("Mac.HmacSHA512",
                        "com.gm.crypto.provider.HmacCore$HmacSHA512");
                    put("Alg.Alias.Mac.OID.1.2.840.113549.2.11", "HmacSHA512");
                    put("Alg.Alias.Mac.1.2.840.113549.2.11", "HmacSHA512");

                    put("Mac.HmacPBESHA1",
                        "com.gm.crypto.provider.HmacPKCS12PBESHA1");

                    // PBMAC1

                    put("Mac.PBEWithHmacSHA1",
                        "com.gm.crypto.provider.PBMAC1Core$HmacSHA1");
                    put("Mac.PBEWithHmacSHA224",
                        "com.gm.crypto.provider.PBMAC1Core$HmacSHA224");
                    put("Mac.PBEWithHmacSHA256",
                        "com.gm.crypto.provider.PBMAC1Core$HmacSHA256");
                    put("Mac.PBEWithHmacSHA384",
                        "com.gm.crypto.provider.PBMAC1Core$HmacSHA384");
                    put("Mac.PBEWithHmacSHA512",
                        "com.gm.crypto.provider.PBMAC1Core$HmacSHA512");

                    put("Mac.SslMacMD5",
                        "com.gm.crypto.provider.SslMacCore$SslMacMD5");
                    put("Mac.SslMacSHA1",
                        "com.gm.crypto.provider.SslMacCore$SslMacSHA1");
                     ...
                     * KeyStore
                     */
                    put("KeyStore.JCEKS", "com.gm.crypto.provider.JceKeyStore");
                    ...
                    put("KeyGenerator.SunTlsPrf",
                            "com.gm.crypto.provider.TlsPrfGenerator$V10");
                    put("KeyGenerator.SunTls12Prf",
                            "com.gm.crypto.provider.TlsPrfGenerator$V12");

                    put("KeyGenerator.SunTlsMasterSecret",
                        "com.gm.crypto.provider.TlsMasterSecretGenerator");
                    ...
                    put("KeyGenerator.SunTlsKeyMaterial",
                        "com.gm.crypto.provider.TlsKeyMaterialGenerator");
                    put("Alg.Alias.KeyGenerator.SunTls12KeyMaterial",
                        "SunTlsKeyMaterial");

                    put("KeyGenerator.SunTlsRsaPremasterSecret",
                        "com.gm.crypto.provider.TlsRsaPremasterSecretGenerator");
