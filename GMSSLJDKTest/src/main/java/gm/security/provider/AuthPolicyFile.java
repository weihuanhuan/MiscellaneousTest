...
import gm.security.provider.PolicyParser.GrantEntry;
import gm.security.provider.PolicyParser.PermissionEntry;
import gm.security.provider.PolicyParser.PrincipalEntry;
import gm.security.util.Debug;
import gm.security.util.PolicyUtil;
import gm.security.util.PropertyExpander;

/**
 * See {@code com.gm.security.auth.PolicyFile} for the class description.
 ...
 *             {@code gm.security.provider.PolicyFile}.
        ...
        AccessController.doPrivileged(new PrivilegedAction<ResourceBundle>() {
            @Override public ResourceBundle run() {
                return (ResourceBundle.getBundle
                        ("gm.security.util.AuthResources"));
            }
        });
