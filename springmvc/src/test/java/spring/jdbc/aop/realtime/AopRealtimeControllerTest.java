package spring.jdbc.aop.realtime;
...
import spring.jdbc.aop.realtime.config.AopRealtimeConfig;
...
@ContextConfiguration(classes = {HsqldbConfig.class, MyBatisConfig.class, MybatisTransactionConfig.class
        , AopTransactionConfig.class, AopRealtimeConfig.class})
@WebAppConfiguration("web")
@ExtendWith(SpringExtension.class)
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class AopRealtimeControllerTest {
    ...
    void insertFailWithTransactional() throws Exception {
        ResultActions perform = mockMvc.perform(MockMvcRequestBuilders.get("/mybatisAopRealtime/update-success-with-transactional"));
