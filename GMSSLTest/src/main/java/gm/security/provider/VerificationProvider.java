...
import gm.security.action.PutAllAction;

import gm.security.rsa.SunRsaSignEntries;

/**
 * GMProvider used for verification of signed JAR files *if* the Sun and
...
public final class VerificationProvider extends Provider {
    ...
    static {
        boolean b;
        try {
            Class.forName("gm.security.provider.Sun");
            Class.forName("gm.security.rsa.SunRsaSign");
            b = false;
    ...
    public VerificationProvider() {
        super("SunJarVerification", 1.8d, "Jar Verification GMProvider");
