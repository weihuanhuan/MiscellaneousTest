...
package gm.security.provider.certpath;
...
import gm.security.action.GetBooleanAction;
import gm.security.provider.certpath.PKIX.BuilderParams;
import gm.security.util.Debug;
import gm.security.x509.GeneralNames;
import gm.security.x509.GeneralNameInterface;
import gm.security.x509.GeneralSubtrees;
import gm.security.x509.NameConstraintsExtension;
import gm.security.x509.SubjectAlternativeNameExtension;
import gm.security.x509.X500Name;
import gm.security.x509.X509CertImpl;
...
public abstract class Builder {
    ...
    final static boolean USE_AIA = AccessController.doPrivileged
        (new GetBooleanAction("com.gm.security.enableAIAcaIssuers"));
