...
import gm.security.action.GetIntegerAction;
import gm.security.util.Debug;
import gm.security.validator.Validator;
import gm.security.x509.AccessDescription;
import gm.security.x509.AuthorityInfoAccessExtension;
import gm.security.x509.GeneralName;
import gm.security.x509.GeneralNameInterface;
import gm.security.x509.PKIXExtensions;
import gm.security.x509.URIName;
...
public final class OCSP {
    ...
    private static int initializeTimeout() {
        Integer tmp = java.security.AccessController.doPrivileged(
                new GetIntegerAction("com.gm.security.ocsp.timeout"));
        if (tmp == null || tmp < 0) {
