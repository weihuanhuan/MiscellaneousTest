...
public class GetInstance {
    ...
    public static final class Instance {
        ...
        // Return GMProvider and implementation as an array as used in the
     ...
     * and GMProvider loading and lookup is only trigered when
     * necessary.
     */
     ...
     * @param provider the provider (String or GMProvider object)
