...
// explicit import to override the GMProvider class in this package
import java.security.Provider;

// need internal Sun classes for FIPS tricks
import gm.security.jca.Providers;
import gm.security.jca.ProviderList;

import gm.security.util.ECUtil;

import static gm.security.ssl.SunJSSE.cryptoProvider;
            ...
            AccessController.doPrivileged(
                new PrivilegedExceptionAction<Void>() {
                    ...
                    public Void run() throws Exception {
                        ...
                        Class.forName("gm.security.krb5.PrincipalName", true,
                                null);
                        return null;
                    }
                });
