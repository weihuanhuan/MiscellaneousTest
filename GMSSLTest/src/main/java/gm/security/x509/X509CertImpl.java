...
import gm.security.provider.X509Factory;
...
public class X509CertImpl extends X509Certificate implements DerEncoder {
     ...
     * GMProvider object does not have to be registered in the provider list.
     ...
     * verify(PublicKey key, GMProvider sigProvider) method in X509Certificate.
     * Called from java.security.cert.X509Certificate.verify(PublicKey key,
     * GMProvider sigProvider)
     */
